...
// maxTextLen limits the text passed to the embedding model to avoid token limits.
const maxTextLen = 2000

// batchSize limits how many texts we embed per Ollama request.
const batchSize = 8
...
// Embed generates embeddings for each text. Empty texts produce zero vectors.
func (e *OllamaEmbedder) Embed(ctx context.Context, texts []string) ([][]float32, error) {
	// Trim and truncate inputs.
